...
export default function WhatsAppFloat() {
  ...
  return (
    <div className="fixed bottom-7 right-7 z-50 flex flex-col items-end gap-3">
      {/* Bubble */}
      {showBubble && (
        <div className="bg-white rounded-xl shadow-xl border border-gray-100 px-4 py-3 max-w-[220px] animate-fade-in-up">
          <p className="text-[#19385C] font-bold text-xs mb-1">Dr. Ben — Assistente Jurídico</p>
          <p className="text-gray-600 text-xs leading-relaxed">
            Olá! Posso ajudá-lo com sua dúvida jurídica agora mesmo. 😊
          </p>
        </div>
      )}
      ...
      <a
        ...
        aria-label="WhatsApp"
        className="w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-green-400/40 hover:scale-110 transition-transform"
      >
