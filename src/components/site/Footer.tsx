...
const phoneWA      = '(86) 99482-0054';
const email        = 'contato@mauromoncao.adv.br';
const address      = 'Parnaíba – PI | Fortaleza – CE | São Luís – MA';
    ...
    <footer className="bg-[#19385C] text-white border-t border-white/5">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href={`mailto:${email}`} className="text-sm text-white/75 hover:text-[#E8B84B] transition-colors">
                  {email}
                </a>
              </div>
              <div className="flex items-start gap-2.5">
      ...
      <div className="border-t border-white/5">
        <div className="container py-4 flex flex-col sm:flex-row justify-between items-center text-xs text-white/60 gap-2">
          <p>
            &copy; {year} Mauro Monção Advogados Associados. Todos os direitos reservados. OAB/PI 22.291
          </p>
