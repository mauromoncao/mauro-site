...
const escritorios = [
  {
    estado: 'Piauí',
    cidade: 'Parnaíba',
    endereco: 'Av. Leonardo de Carvalho Castelo Branco, nº 2835, Sala 12, Bairro São Benedito',
    cep: 'Parnaíba – PI',
    icon: (
  ...
  },
  {
    estado: 'Ceará',
    cidade: 'Fortaleza',
    endereco: 'Rua Monsenhor Bruno, nº 1153, Sala 1423, B. Aldeota, Centro Empresarial Scopa Platinum Corporate',
    cep: 'Fortaleza – CE',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/>
  ...
  return (
    <SiteLayout>
      ...
      <section className="py-20 bg-[#f7f5f0]">
        <div className="container">
          <div className="text-center mb-12">
            <span className="text-[#E8B84B] text-sm font-bold uppercase tracking-[.2em]">Pilares</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            {pilares.map(({ icon, label, text }) => (
              <div
                key={label}
                className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:border-[#E8B84B]/30 hover:shadow-lg transition-all text-center"
              >
                <div className="w-16 h-16 bg-[#19385C] rounded-2xl flex items-center justify-center text-[#E8B84B] mx-auto mb-5">
                  {icon}
                </div>
          ...
          <div className="bg-[#19385C] rounded-3xl p-10 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {valores.map((v) => (
                <span
                  key={v}
                  className="bg-[#E8B84B]/20 border border-[#E8B84B]/50 text-[#E8B84B] px-5 py-2 rounded-full text-sm font-semibold"
                >
                  {v}
                </span>
              ))}
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="flex justify-center lg:justify-start">
              <div
                className="relative w-full max-w-[420px] rounded-3xl overflow-hidden shadow-2xl border border-[#E8B84B]/20"
              ...
              >
                ...
                <div className="p-6 border-t border-[#E8B84B]/20">
                  <p className="text-[#E8B84B] text-xs font-bold uppercase tracking-widest mb-1">
                    Fundador e Diretor Executivo
                  </p>
                  <h3 className="text-xl font-bold text-white font-serif">
                    Mauro Monção da Silva
                  </h3>
                  <p className="text-white/60 text-xs mt-1">OAB/PI 22.291</p>
                  <div className="flex flex-wrap gap-2 mt-4">
                    {['Direito Tributário', 'Advocacia Pública', 'Planejamento Sucessório'].map((tag) => (
                      <span key={tag} className="text-[10px] bg-[#E8B84B]/15 border border-[#E8B84B]/30 text-[#E8B84B] px-2.5 py-1 rounded-full">
                        {tag}
                      </span>
                    ))}
                  </div>
            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {especializacoes.map((esp) => (
                    <div key={esp} className="flex items-center gap-2">
                      <svg className="w-4 h-4 text-[#E8B84B] shrink-0" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 mt-8 bg-[#E8B84B] text-[#19385C] px-7 py-3.5 rounded-full text-sm font-bold hover:brightness-110 transition-all shadow-lg shadow-[#E8B84B]/25"
              >
      ...
      <section className="py-20 bg-[#f7f5f0]">
        <div className="container">
          <div className="text-center mb-12">
            <span className="text-[#E8B84B] text-sm font-bold uppercase tracking-[.2em]">Localização</span>
            <h2 className="text-3xl lg:text-4xl font-bold text-[#19385C] mt-2 font-serif">
              Nossos Escritórios
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {escritorios.map((e) => (
              <div
                key={e.estado}
                className="bg-white rounded-2xl p-7 shadow-sm border border-gray-100 hover:border-[#E8B84B]/30 hover:shadow-lg transition-all"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-[#19385C] rounded-xl flex items-center justify-center text-[#E8B84B]">
                    {e.icon}
                  </div>
                  <div>
                    <p className="text-[#E8B84B] text-xs font-bold uppercase tracking-wider">{e.estado}</p>
                ...
                <p className="text-[#E8B84B] font-semibold text-sm mt-2">{e.cep}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-12 bg-[#19385C] rounded-3xl p-10 text-white max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
              {[
                ...
                <div key={c.label}>
                  <p className="text-[#E8B84B] text-xs font-bold uppercase tracking-wider mb-1">{c.label}</p>
                  ...
                  {c.isWA && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1 text-xs text-[#E8B84B]/80 hover:text-[#E8B84B] mt-1 transition-colors"
                    >
            ...
            <div className="text-center mt-6 pt-6 border-t border-white/10">
              <p className="text-[#E8B84B] text-xs font-bold uppercase tracking-wider mb-1">E-mail</p>
              <a href="mailto:contato@mauromoncao.adv.br" className="text-white hover:text-[#E8B84B] transition-colors font-medium">
        ...
        <div className="container text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#E8B84B] text-[#19385C] px-7 py-3.5 rounded-full text-sm font-bold hover:brightness-110 transition-all"
            >
              Falar pelo WhatsApp
            </a>
            <Link
              href="/contato"
              className="inline-flex items-center gap-2 border border-white/25 text-white px-7 py-3.5 rounded-full text-sm font-semibold hover:border-[#E8B84B]/50 hover:text-[#E8B84B] transition-all"
            >
