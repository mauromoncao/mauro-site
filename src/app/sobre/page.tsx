        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <Link
                href="/contato"
                className="inline-flex items-center gap-2.5 mt-8 text-[#0f2340] px-7 py-3.5 rounded-full text-sm font-bold hover:brightness-110 transition-all shadow-lg"
                style={{ background: 'linear-gradient(135deg,#D4A017,#F0C040)', boxShadow: '0 0 16px rgba(212,160,23,0.5)' }}
              >
                <div className="w-7 h-7 rounded-full overflow-hidden border-2 border-[#0f2340]/20 shrink-0">
