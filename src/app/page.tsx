    ...
    <SiteLayout>
        ...
        <div className="container relative z-10 h-full">
          ...
          >
            ...
            <div className="flex flex-col justify-center order-2 lg:order-1">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 border border-[#E8B84B]/60 bg-[#E8B84B]/12 rounded-full px-4 py-2 text-sm text-[#E8B84B] font-bold tracking-[.2em] uppercase mb-6 w-fit">
                <span className="w-1.5 h-1.5 rounded-full bg-[#E8B84B] animate-badge-pulse shrink-0" />
                Advocacia · CE · PI · MA
              </div>
              ...
              <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mb-8 mt-4">
                {[
                  ...
                  <span key={s.l} className="flex items-baseline gap-1.5 text-sm text-white/80">
                    <strong className="text-[#E8B84B] font-bold text-xl font-serif leading-none">
                      {s.v}
                    </strong>
                    {s.l}
                  </span>
              ...
              <p className="text-white/60 text-sm mt-8 tracking-wide">
                OAB/PI 22.291 · Atendimento nacional · Sedes em CE, PI e MA
              </p>
            </div>
            ...
            <div className="relative order-1 lg:order-2 flex justify-center items-center pb-8 lg:pb-0">
              ...
              >
                ...
                <div className="relative w-full" style={{ paddingBottom: '48%' }}>
                  <svg viewBox="0 0 500 240" className="absolute inset-0 w-full h-full" fill="none">
                    <defs>
                      ...
                      <linearGradient id="hGold" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor="#E8B84B" stopOpacity=".9" />
                        <stop offset="100%" stopColor="#E8B84B" stopOpacity=".2" />
                      </linearGradient>
                      <linearGradient id="hFade" x1="0" y1="1" x2="0" y2="0">
                        <stop offset="0%" stopColor="#0f2340" stopOpacity=".95" />
                    ...
                    <rect x="62"  y="72"  width="16"  height="23"  fill="url(#hGold)" opacity=".5"/>
                    <rect x="100" y="140" width="38"  height="100" fill="url(#hGold)" opacity=".4"/>
                    <rect x="143" y="80"  width="70"  height="160" fill="url(#hGold)" opacity=".9"/>
                    <rect x="155" y="55"  width="46"  height="25"  fill="url(#hGold)" opacity=".9"/>
                    <rect x="164" y="32"  width="28"  height="23"  fill="url(#hGold)" opacity=".9"/>
                    <rect x="170" y="14"  width="16"  height="18"  fill="url(#hGold)" opacity=".9"/>
                    <rect x="218" y="108" width="52"  height="132" fill="url(#hGold)" opacity=".55"/>
                    <rect x="229" y="82"  width="30"  height="26"  fill="url(#hGold)" opacity=".55"/>
                    <rect x="275" y="90"  width="60"  height="150" fill="url(#hGold)" opacity=".65"/>
                    <rect x="287" y="64"  width="36"  height="26"  fill="url(#hGold)" opacity=".65"/>
                    <rect x="340" y="118" width="48"  height="122" fill="url(#hGold)" opacity=".45"/>
                    <rect x="350" y="95"  width="28"  height="23"  fill="url(#hGold)" opacity=".45"/>
                    <rect x="393" y="138" width="55"  height="102" fill="url(#hGold)" opacity=".35"/>
                    <rect x="455" y="155" width="45"  height="85"  fill="url(#hGold)" opacity=".3"/>
                    <rect x="0"   y="235" width="500" height="5"   fill="#E8B84B"    opacity=".2"/>
                  ...
                  <div className="absolute bottom-3 left-5 right-5 flex items-end justify-between z-10">
                    ...
                    <span className="text-white/60 text-[11px] tracking-widest">CE · PI · MA</span>
                  </div>
                </div>

                {/* Stats row */}
                <div className="grid grid-cols-4 divide-x divide-white/[.08] border-t border-white/[.08]">
                  {[
                    { v: '+15', l: 'Anos' },
                    { v: '500+', l: 'Clientes' },
                    { v: '3', l: 'Estados' },
              ...
              <div className="absolute -bottom-3 -right-2 lg:-right-6 bg-[#0f2340] border border-[#E8B84B]/35 rounded-2xl px-3.5 py-2.5 flex items-center gap-2.5 shadow-2xl">
                ...
                <span className="w-2 h-2 rounded-full bg-green-400 animate-badge-pulse ml-1 shrink-0" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-3.5">
                {diferenciais.map((item, i) => (
                  <div key={i} className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-[#E8B84B] mt-0.5 shrink-0" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
            ...
            <div className="bg-[#19385C] rounded-3xl p-8 text-white shadow-2xl">
              <div className="w-12 h-12 bg-[#E8B84B]/15 rounded-2xl flex items-center justify-center mb-5">
                <svg className="w-7 h-7 text-[#E8B84B]" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                </svg>
              </div>
      ...
      <section className="py-20 bg-[#f7f5f0]">
        <div className="container">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-4">
            ...
            <Link
              href="/blog"
              className="inline-flex items-center gap-2 text-[#E8B84B] font-semibold hover:underline shrink-0 text-sm"
            >
              Ver todos
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                <path d="M5 12h14M12 5l7 7-7 7" />
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-xs text-[#E8B84B] font-bold bg-[#E8B84B]/20 px-2 py-0.5 rounded-full">
                      {post.cat}
                    </span>
                    <span className="text-xs text-gray-400">{post.date}</span>
                  </div>
                  <h3 className="text-base font-bold text-[#19385C] mb-2 group-hover:text-[#E8B84B] transition-colors leading-snug font-serif">
                    {post.title}
                  </h3>
      ...
      <section className="py-20 bg-[#19385C] text-white">
        <div className="container text-center">
          <div className="inline-flex items-center gap-2 bg-[#E8B84B]/20 border border-[#E8B84B]/60 rounded-full px-4 py-2 text-sm text-[#E8B84B] font-bold uppercase tracking-[.15em] mb-6">
            Atendimento 24h
          </div>
